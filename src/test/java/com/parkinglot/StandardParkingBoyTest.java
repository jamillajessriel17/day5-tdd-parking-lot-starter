...
public class StandardParkingBoyTest {
    ...
    @Test
    void should_return_right_car_when_fetch_the_two_cars_given_standard_parking_boy_with_two_parking_lots_both_with_a_parked_car() {
        //given
        ParkingLot parkingLot = new ParkingLot(1);
        ParkingLot parkingLot1 = new ParkingLot(5);
        Car car = new Car();
        Car car1 = new Car();
        StandardParkingBoy standardParkingBoy = new StandardParkingBoy(List.of(parkingLot, parkingLot1));
        ParkingTicket parkingTicket = standardParkingBoy.park(car);
    ...
    @Test
    void should_return_UnrecognizedParkingTicketException_when_fetch_given_standard_parking_boy_with_two_parking_lots_and_used_ticket() {
        //given
        ParkingLot parkingLot = new ParkingLot(0);
        ParkingLot parkingLot1 = new ParkingLot();
        Car car = new Car();
    ...
    @Test
    void should_return_NoAvailablePositionException_when_park_given_standard_parking_boy_with_two_full_parking_lots() {
        //given
        ParkingLot parkingLot = new ParkingLot(0);
